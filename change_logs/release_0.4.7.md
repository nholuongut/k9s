...
I've created [Popeye](https://github.com/nholuongut/popeye) to help with cluster sanitation and best practices. Since K9s folks are so awesome, you're getting a sneak peek! I figured why not integrate it with K9s? No need to install yet another CLI right? Provided I did not mess this up too much, you should now be able to use command mod `:popeye` to access Popeye sanitizer reports within
...
+ Great find! Thank you @swe-covis! Moved alias view to `Ctrl-A` [Issue #156](https://github.com/nholuongut/k9s/issues/156)
+ Added toggle autoscroll via `s` key [Issue #155](https://github.com/nholuongut/k9s/issues/155)
